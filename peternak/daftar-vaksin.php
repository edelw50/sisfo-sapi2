...
?>
              ...
              <div class="row vh-100 bg-light rounded">
                  <div class="col">
                        <br>
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addVaksin"><i class="fa-solid fa-circle-plus me-2"></i>Tambah Vaksin Sapi</button>
                        <br><br>
                        <!-- modal vaksin -->
    ...
    $(document).ready(function() {
      $('#tablevaksin').DataTable({
        ...
        'order': [],
        'ajax': {
          'url': 'peternak/vaksin/fetch_data.php',
          'type': 'post',
        },
        "aoColumnDefs": [{
            "bSortable": false,
    ...
    function submitForm(){
      $.ajax({
          url: "peternak/vaksin/add_data.php",
          type: "post",
    ...
    function updateForm(){
      $.ajax({
          url: "peternak/vaksin/update_data.php",
          type: "post",
    ...
    $('#tablevaksin').on('click', '.editbtn ', function(event) {
      ...
      $.ajax({
        url: "peternak/vaksin/get_single_data.php",
        data: {
          id: id
        },
        type: 'post',
    ...
    $(document).on('click', '.deleteBtn', function(event) {
      ...
      if (confirm("Are you sure want to delete this Jenis Sapi ? ")) {
        $.ajax({
          url: "peternak/vaksin/delete_data.php",
          data: {
            id: id
          },
          type: "post",
