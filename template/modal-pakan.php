             ...
             <form id="updatePakanForm" role="form">
                 ...
                 <div class="modal-body">
                     <div class="input-group mb-3">
                         ...
                         <input type="text" name="pakan" id="pakan" class="form-control" aria-label="Pakan Sapi"
                             aria-describedby="basic-addon1">
                     </div>
                 </div>
                 <div class="modal-footer">
                     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                     <button type="submit" class="btn btn-success">Update Pakan Sapi</button>
                 </div>
             </form>
         </div>
     </div>
             ...
             <form id="addPakanForm" role="form">
                 <div class="modal-body">
                     <div class="input-group mb-3">
                         ...
                         <input type="text" name="pakan" id="pakan" class="form-control" placeholder="Pakan Sapi"
                             aria-label="Pakan Sapi" aria-describedby="basic-addon1">
                     </div>
                 </div>
                 <div class="modal-footer">
                     <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                     <button type="submit" id="addPakanFormButton" class="btn btn-success">Tambah Pakan Sapi</button>
                 </div>
             </form>
         </div>
     </div>
