             ...
             <form id="updateJenisForm" role="form">
                 ...
                 <div class="modal-body">
                     <div class="input-group mb-3">
                         ...
                         <input type="text" name="jenis" id="jenis" class="form-control" aria-label="Jenis Sapi"
                 ...
                 <div class="modal-footer">
                     ...
                     <button type="submit" class="btn btn-success">Update Jenis Sapi</button>
                 </div>
             </form>
         </div>
     </div>
         ...
         <div class="modal-content">
             ...
             <form id="addJenisForm" role="form">
                 <div class="modal-body">
                     <div class="input-group mb-3">
                         <span class="input-group-text text-bg-primary"><i class="fa-solid fa-cow"></i></span>
                         <input type="text" name="jenis" id="jenis" class="form-control" placeholder="Jenis Sapi"
                             aria-label="Jenis Sapi" aria-describedby="basic-addon1">
                     </div>
                     <div class="input-group mb-3">
                         <span class="input-group-text text-bg-primary"><i class="fa-solid fa-address-card"></i></span>
