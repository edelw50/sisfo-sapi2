...
<div class="row vh-100 bg-light rounded">
    <div class="col">
        <br>
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addJenis"><i
                class="fa-solid fa-circle-plus me-2"></i>Tambah Data Jenis Sapi</button>
        <br><br>
        <!-- modal jenis -->
